...
<table>
<tr>
<td>![Hand Demo](Hand_Demo.gif)</td><td>![](Hand_Demo2.gif)</td>
</tr></table>
...
* Developing a classifier should be possible given input uniformity and a discrete number of 
...
![PCA Graphs](Noah_work_graphs/Noah_PCA_Graphs.pdf)
